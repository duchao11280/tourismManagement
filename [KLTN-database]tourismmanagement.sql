...
INSERT INTO `comment` VALUES (14, 1, 'Cong Vien thu vi, co nhieu hoat dong vui choi giai tri', 4, 5, '2022-06-23 10:29:00');
...
INSERT INTO `image` VALUES (119, '1655954954410_anhsaoxanh.png', NULL, 35, 0);
INSERT INTO `image` VALUES (120, '1655954954425_anhsaoxanh2.jpg', NULL, 35, 0);
INSERT INTO `image` VALUES (121, '1655954954426_anhsaoxanh3.png', NULL, 35, 0);
INSERT INTO `image` VALUES (122, '1655980332842_circle_K_NguyenHue1.jpg', NULL, 36, 0);
INSERT INTO `image` VALUES (123, '1655980332847_circle_K_NguyenHue2.jpg', NULL, 36, 0);
...
INSERT INTO `services` VALUES (35, 'Anh Sao Xanh Hotel', 1, 'Tọa lạc tại vị trí lý tưởng ở Quận Tân Phú của Thành phố Hồ Chí Minh, Anh Sao Xanh Hotel cách Công viên văn hóa Đầm Sen 1,7 km, Chùa Giác Lâm 3,5 km và Chợ Tân Định 9 km. Khách sạn 1 sao này cung cấp dịch vụ lễ tân 24 giờ, dịch vụ phòng và WiFi miễn phí. Chỗ nghỉ có thể bố trí chỗ đỗ xe riêng cho khách với một khoản phụ phí.\r\n\r\nTất cả phòng nghỉ tại đây đều được trang bị máy điều hòa, truyền hình cáp màn hình phẳng, tủ lạnh, ấm đun nước, vòi sen, máy sấy tóc và tủ để quần áo. Ngoài ra, phòng còn có phòng tắm riêng với đồ vệ sinh cá nhân miễn phí.\r\n\r\nChợ ẩm thực đường phố Bến Thành và Dinh Thống Nhất đều nằm cách Anh Sao Xanh Hotel 9 km. Sân bay gần nhất là sân bay quốc tế Tân Sơn Nhất, nằm trong bán kính 6 km từ chỗ nghỉ.', 5, '202/18 Tô Hiệu, Phú Thạnh, Tân Phú, Thành phố Hồ Chí Minh, Việt Nam', '0911654994', '10.773848246985251', '106.62860026833418', 0);
INSERT INTO `services` VALUES (36, 'Circle K Nguyễn Huệ', 2, 'Chuỗi cửa hàng tiện lợi có nhiều món ăn nhẹ cùng đồ uống nóng và lạnh', 89, '82 Nguyễn Huệ, Bến Nghé, Quận 1, Thành phố Hồ Chí Minh, Việt Nam', '02838242414', '10.775354468305181', '106.70289153949813', 0);
...
INSERT INTO `user` VALUES (2, 'duchao111', '$2a$14$4U/phSn3BvzVxThRoqJiMu2y2ctLepQlGqKSh/CJqrCQo54tMqeQ6', 'Đức Hảo', 'duchao3003@gmail.com', '0799792465', 0, 0, '2022-06-24 21:25:51');
